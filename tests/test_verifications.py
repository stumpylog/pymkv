...
from pymkv.Verifications import verify_mkvmerge, verify_matroska, verify_recognized, verify_supported
...
class TestVerifyMatroska:
    ...
    def test_verify_matroska_invalid_type(self, mocker):
    ...
    def test_verify_matroska_file_not_exists(self, mocker):
...
class TestVerifyRecognized:
    ...
    def test_verify_recognized_invalid_type(self, mocker):
...
class TestVerifySupported:
    ...
    def test_verify_supported_invalid_type(self, mocker):
    ...
    def test_verify_supported_file_not_exists(self, mocker):
